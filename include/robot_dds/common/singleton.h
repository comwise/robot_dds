/**
 * Copyright (c) 2025 COMWISE Inc. All rights reserved.
 */
#ifndef __COMWISE__COMMON__SINGLETON__H__
#define __COMWISE__COMMON__SINGLETON__H__
...
#endif  // __COMWISE__COMMON__SINGLETON__H__
